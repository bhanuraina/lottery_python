...
def buy_lottery_ticket():
  global cash
  cash -= 50
  entered_numbers = input('Enter Numbers: ')
...
def drawing_result(ticket_numbers,winning_numbers):
    ...
    prizes = [0,0,0,400,2000,4000,100000]
